...
accept_file = open("unit_tests/inputs/1_6g_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_6g_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_6g import prob_1_6g
test_machine = prob_1_6g
