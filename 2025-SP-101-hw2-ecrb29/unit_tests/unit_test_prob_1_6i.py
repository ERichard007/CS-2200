...
accept_file = open("unit_tests/inputs/1_6i_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_6i_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_6i import prob_1_6i
test_machine = prob_1_6i
