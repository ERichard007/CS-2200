...
accept_file = open("unit_tests/inputs/1_6d_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_6d_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_6d import prob_1_6d
test_machine = prob_1_6d
