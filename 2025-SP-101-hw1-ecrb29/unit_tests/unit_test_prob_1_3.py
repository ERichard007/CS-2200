...
accept_file = open("unit_tests/inputs/1_3_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_3_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_3 import prob_1_3
test_machine = prob_1_3
