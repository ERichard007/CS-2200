...
accept_file = open("unit_tests/inputs/1_6e_accepts.txt", "r")
reject_file = open("unit_tests/inputs/1_6e_rejects.txt", "r")
...
### Test Inputs ###
from prob_1_6e import prob_1_6e
test_machine = prob_1_6e
